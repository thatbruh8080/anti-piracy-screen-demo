...
Emulator  = "C:/Users/Jummy/Downloads/openmsx-21.0-windows-vc-x64-bin/openmsx";									//-- Path to the emulator to launch the project (string)
...
LibModules = [ "system", "bios", "print", "vdp", "input", "memory", "draw" ];
...
EmulExtraParam = "-machine Philips_NMS_8250";
